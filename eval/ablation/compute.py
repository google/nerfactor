...
flags.DEFINE_string('ours_dir', '', "")
flags.DEFINE_string('wo_geom_refine_dir', '', "")
flags.DEFINE_string('wo_geom_pretrain_dir', '', "")
flags.DEFINE_string('wo_smooth_dir', '', "")
flags.DEFINE_string('wo_learned_brdf_dir', '', "")
...
def main(_):
    ...
    for model in tqdm(models, desc="Models"):
        run_dir = getattr(FLAGS, model + '_dir')
        ...
        for batch_dir in tqdm(batch_dirs, desc="Test views"):
            ...
            data_view_dir = join(FLAGS.data_root, metadata['id'])
        ...
        for batch_dir in tqdm(
            ...
            gt_normal_path = join(FLAGS.data_root, metadata['id'], 'normal.png')
            # Load
            pred, gt = {}, {}
